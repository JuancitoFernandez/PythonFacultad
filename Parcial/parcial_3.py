...
print()
# Lista de Jedi con su respectiva información
jedis = [
    {
        "name": "Qui-Gon Jinn",
        "rank": "Jedi Master",
...
# A. Lista ordenada por nombre y especie
jedis_ordenados = sorted(jedis, key=lambda x: (x["name"], x["species"]))
...
# E. Lista de los Jedi que empiezan con 'A'
jedis_con_a = []
for jedi in jedis:
...
# G. Indicar qué Jedi usaron sable de luz amarillo o violeta
for jedi in jedis:
...
# I. Mostrar los Jedi de rango Grand Master
